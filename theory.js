...
«Песенка / мелодия / куплет» → ОДИН блок, barlines:"auto", непрерывная мелодия (последовательные одиночные звуки, 4–8 тактов). НЕ дробить на мини-станы и НЕ вставлять отдельные такты T53/D7 целыми между нотами мелодии; гармонию — label на ноте такта или аккорд на той же доле.
